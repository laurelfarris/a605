...
%\titleformat{\section}%
%  {\filcenter\fontsize{18}{20}\selectfont\bfseries}
...
%  {\filcenter\fontsize{14}{16}\selectfont\bfseries\itshape}
...
\begin{enumerate}[noitemsep]
    ...
    \item \underline{Absorption}: requires photon of energy $\sim h\nu_{0}$
        The mean intensity, $J_{\nu}$ is given by:
        \[
            J_{\nu} \equiv \frac{1}{4\pi} \int{ I_{\nu} \;\mathrm{d}\Omega }
            \]
    \item \mar{29}\underline{Stimulated emission}
\end{enumerate}
...
\mar{31}The second term here for $\kappa_{\nu}$ corresponds to
